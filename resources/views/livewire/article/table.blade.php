    ...
    @foreach ($this->articles() as $article)
        <div class="border-b-2 border-t-2 border-gray-200 p-4 pb-2 flex justify-between group bg-white">
            ...
            <div class="flex flex-wrap items-center justify-between w-full">
                <div class="w-full md:w-4/12 mb-2">
                    ...
                    @if ($article->topics->isNotEmpty())
                        @foreach ($article->topics as $topic)
                            <a href="#"
                                class="inline-block text-gray-600 border border-gray-300 px-2 py-0 rounded mr-2 mb-1 bg-white">
                                {{ $topic->name }}
                            </a>
                        @endforeach
                    @endif
                ...
                {{-- <div>
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5 text-gray-600 mr-1">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <div class="text-md text-gray-600">Thu, Dec 25, 1975 2:15 PM</div>
                    </div>
                </div> --}}
