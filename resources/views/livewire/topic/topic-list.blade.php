    ...
    <div class="flex flex-wrap items-center justify-between w-full">
        @foreach ($this->topics() as $topic)
            <div class="w-full md:w-4/12">
                <div class="flex flex-wrap items-center justify-between w-full m-1 border-2 border-gray-200 p-2 pb-1 group @if(!$topic->live) bg-red-100 @else bg-white @endif">
                    <div class="ml-2">
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <div class="text-sm text-gray-600">
                                {{ $topic->created_at->toFormattedDateString() }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            <div class="flext items-center">
                                ...
                                <a href="{{ route('topic.edit', $topic) }}" class="inline-block border text-sm border-blue-400 text-blue-400 font-semibold rounded-lg px-2 py-1 bg-white">
                                    Edit topic
                                </a>
                            </div>
                        </div>
